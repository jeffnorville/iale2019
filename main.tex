% from http://www.brian-amberg.de/uni/poster/
% template from baposter Template (using Brian Amberg's LaTeX Poster Template)
...
%%% Title %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{\sf\bf
	Sustainable, Multifunctional Ag Landscapes % Agroecology and policy instruments for s
}

%%% Authors %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{
	\vspace{1em} Corentin Barbu, Vincent Martinet, Jeff Norville\\
	{\smaller corentin.barbu@inra.fr, vincent.martinet@inra.fr, jeffrey.norville@inra.fr}
}
%%% Logo %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{
...
\setlength\fboxrule{0.5pt}
	\fbox{
		\begin{minipage}{15em}
			\includegraphics[width=8em,height=4em]{grassland-prairie_Bourgogne.png}
			%\includegraphics[width=4em,height=4em]{grassland-prairie_Picardie.png} \\
			%\includegraphics[width=10em,height=4em]{grassland-prairie_MP.png}
			%\includegraphics[width=4em,height=4em]{grassland-prairie_RhoneAlpes.png}
		\end{minipage}
	}
}

\headerbox{Problem}{name=problem,column=0,row=0}{
Of France's 20 million hectares (ha), about half are useful agricultural (ag) land. Of this .
\includegraphics[width=0.99\linewidth]{grassland-prairie_Picardie.png}
}
...
\textbf{Economy} $G_0$ is a random graph. Add each non-existing edge with $p_A$, delete each existing edge with $p_D$ probability. \\
\textbf{Economy} $AROPAj$ is an economic-optimization model based on FADN data. \\
\textbf{Agronomy} $unnamed$ is a linear model based on Lasso and GLM  \\
...
% above=models
\headerbox{References}{name=references,column=2,row=3,above=acknowledgements}{
...
\headerbox{Col 3 Talking About Tradeoffs}{name=density,span=1,column=2}{
Network characteristics are extremely sensitive to minor changes in aggregation length. In our previous work \cite{prevWork1} \cite{prevWork2}, we studied the cumulative properties of Elementary Dynamic Network models over the complete time period (i.e., until they reach the stable point of a full network). Here we focus on the more realistc domain of sparse (cumulative) networks. We find that even when snapshot networks are stationary, \textbf{important network characteristics}  (average path length, clustering, betweeness centrality) \textbf{are extremely sensitive to aggregation} (window length). 
\includegraphics[angle=0,width=0.8\linewidth]{grassland_overlap_SAU.png}}

\begin{center}
	\includegraphics[angle=0,width=0.49\linewidth]{ilots_cult.png}
